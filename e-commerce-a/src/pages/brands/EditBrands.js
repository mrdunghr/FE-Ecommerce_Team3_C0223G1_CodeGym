...
export default function EditBrands(){
    ...
    useEffect(() => {
        ...
        axios
            .get(`http://localhost:8080/api/v1/brand/${brandId}`)
            .then((response) => {
                ...
                setChosenCategories(brandData.categories);
    ...
    const handleSubmit =  async (event) => {
        ...
        try {
            const response = await axios.put(`http://localhost:8080/api/v1/brand/${brandId}`, data);
            // Xử lý phản hồi theo cần thiết
            console.log("Sửa brand thành công:", response.data);
                        ...
                        <div className="card-body">
                            ...
                            <div class="clearfix">
                                <div class="text-center">
                                    ...
                                    <Link to={"/brands"}><input type="button" value="Cancel" className="btn btn-danger" id="buttonCancel" /></Link>
                                </div>
                            </div>
                        </div>
                    </form>
